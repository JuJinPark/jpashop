...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        assertEquals("상품준시 상테는 ORDER", OrderStatus.ORDER,getOrder.getStatus());
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문취소된 상품은 갯수가 원복되어야 한다.",10,item.getStockQuantity());
    }
    ...
    public void springDataJpaTest(){
        ...
        Page<Order> allWithMemberDelivery = orderSpringDataRepository.findAllWithMemberDelivery(PageRequest.of(0, 100));
    }
}